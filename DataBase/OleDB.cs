...
namespace DataBase
{
    public class OleDB
    {
        ...
        private static OleDbConnection GetConnection(string ConnectionString)
        {
            try
            {
                if (conn == null)
        ...
        public static DataTable SelectDataTable(string ConnectionString, string SqlString, OleDbParameter[] OleDbParameters)
        {
        ...
        /// <param name="OleDbParameters">SQL语句的参数数组</param>
        public static void UpdateDataTable(DataTable dt, string ConnectionString, string SqlString, OleDbParameter[] OleDbParameters)
        {
            conn = GetConnection(ConnectionString);
            try
            {
        ...
        public static int ExecuteNonQuery(string ConnectionString, string SqlString, OleDbParameter[] OleDbParameters)
        {
            conn = GetConnection(ConnectionString);
            try
            {
        ...
        public static object ExecuteScaler(string ConnectionString, string SqlString, OleDbParameter[] OleDbParameters)
        {
            conn = GetConnection(ConnectionString);
            try
            {
        ...
        public static void ExecuteOleDbTransaction(string ConnectionString, string[] SqlStrings, OleDbParameter[][] OleDbParameters)
        {
            conn = GetConnection(ConnectionString);
            try
            {
